...
test('builds a reconciled executive summary and health status', () => {
  ...
  assert.deepEqual(summary, { bac: 1000000, currentBudget: 1050000, commitments: 700000, actualCost: 600000, etc: 450000, eac: 1050000, vac: -50000, riskExposure: 120000, cpi: 0.86, spi: 0.94, health: 'AT_RISK' });
});
