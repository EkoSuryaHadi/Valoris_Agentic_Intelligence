# Module 05 — Risk-to-Cost Intelligence Architecture

## Boundary

This module owns risk exposure, contingency, risk-adjusted EAC, and response tracking. It consumes Platform Core context and integrates with Cost Management, Forecast Intelligence, EVM, Change, Risk, Procurement, Data Quality, Executive Intelligence, and Reporting as applicable.
