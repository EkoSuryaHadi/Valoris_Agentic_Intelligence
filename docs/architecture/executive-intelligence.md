# Module 08 — Executive Intelligence Architecture

## Boundary

This module owns management insight, KPI, priority actions, decision briefs, and escalation. It consumes Platform Core context and integrates with Cost Management, Forecast Intelligence, EVM, Change, Risk, Procurement, Data Quality, Executive Intelligence, and Reporting as applicable.
