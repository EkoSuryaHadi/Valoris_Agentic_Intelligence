# Module 04 — Change Management Architecture

## Boundary

This module owns change requests, variation orders, scope impact, cost impact, and approval workflow. It consumes Platform Core context and integrates with Cost Management, Forecast Intelligence, EVM, Change, Risk, Procurement, Data Quality, Executive Intelligence, and Reporting as applicable.
