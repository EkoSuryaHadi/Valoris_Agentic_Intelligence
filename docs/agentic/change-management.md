# Module 04 — Change Management Agentic Design

## Change Control Agent

Mission: analyze and assist with change requests, variation orders, scope impact, cost impact, and approval workflow.
